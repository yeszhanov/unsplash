...
var Index = function Index() {
  ...
  var searchImages = function searchImages(count) {
    axios__WEBPACK_IMPORTED_MODULE_3___default.a.get("https://api.unsplash.com/search/photos/?page=1&per_page=".concat(count, "&query=").concat(search, "&client_id=").concat(APP_ID)).then(function (data) {
      setResult([].concat(Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(result), Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(data.data.results)));
    }).catch(function (err) {
...
//# sourceMappingURL=index.js.3de7e20b41231892bb31.hot-update.js.map