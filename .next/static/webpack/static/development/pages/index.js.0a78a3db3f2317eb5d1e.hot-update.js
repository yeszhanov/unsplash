...
var Index = function Index() {
  ...
  var searchImages = function searchImages(count) {
    axios__WEBPACK_IMPORTED_MODULE_3___default.a.get("https://api.unsplash.com/search/photos/?page=1&per_page=".concat(count, "&query=").concat(search, "&client_id=").concat(APP_ID)).then(function (data) {
      setResult([].concat(Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(data.data.results), Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(result)));
    }).catch(function (err) {
...
//# sourceMappingURL=index.js.0a78a3db3f2317eb5d1e.hot-update.js.map