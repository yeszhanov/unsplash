...
var Index = function Index() {
  ...
  var _useState5 = Object(react__WEBPACK_IMPORTED_MODULE_2__["useState"])(null),
      ...
      result = _useState6[0],
      setResult = _useState6[1]; // useEffect(() => {
  //   getImages()
  // }, [])
  ...
  var searchImages = function searchImages(count) {
    axios__WEBPACK_IMPORTED_MODULE_3___default.a.get("https://api.unsplash.com/search/photos/?page=1&per_page=".concat(count, "&query=").concat(search, "&client_id=").concat(APP_ID)).then(function (data) {
      setResult([].concat(Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(images), Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(data.data.results)));
    }).catch(function (err) {
...
//# sourceMappingURL=index.js.be6fc3ab79f3fc0bbdf9.hot-update.js.map