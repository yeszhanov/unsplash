...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Index, [{
    key: "searchImages",
    value: function searchImages(count) {
      var _this2 = this;

      axios__WEBPACK_IMPORTED_MODULE_9___default.a.get("https://api.unsplash.com/search/photos/?page=1&per_page=".concat(count, "&query=").concat(search, "&client_id=").concat(APP_ID)).then(function (data) {
        _this2.setState({
...
//# sourceMappingURL=index.js.2ad6198a92f33335fed9.hot-update.js.map